...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/home/soosang/cocoapi/PythonAPI/coco/annotations')
    parser.add_argument('--imgpath', type=str, default='/home/soosang/cocoapi/PythonAPI/coco/images')
    ...
    with tf.Session(config=config) as sess:
        ...
        if args.checkpoint:
            ...
            if '.ckpt' in pretrain_path:
                ...
                # pretrain_path = '/home/soosang/tf-pose-estimation/models/numpy/openpose_coco.npy'
